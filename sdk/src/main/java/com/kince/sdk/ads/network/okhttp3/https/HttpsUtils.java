package com.kince.sdk.ads.network.okhttp3.https;
...
public class HttpsUtils {
     ...
     *对所有证书进行支持 不管你是CA认证的还是自签名证书
     * @return 返回SSLSocketFactory SSL加密协议是在TCP/IP与Http协议中间的一种加密协议
     */
    public static SSLSocketFactory getSslSocketFactory() {
        //1.生成一个信任管理器类(X509是https使用的一个协议)
        ...
        try {
            //SSL表示加密算法(其他的加密算法 如TLS) 与服务器要保持一直的加密算法
